...
--SP_INGRESA_NUEVO_CLIENTE_PERSONA

procedure SP_INGRESA_NUEVO_CLIENTE_PERSONA(
	cod_resultado out number,
	msg_error out varchar2,
	cursorUsuarioPersona out PKG_CLIENTE.RefCursor,
	sp_rut in varchar2,
	...
	sp_fechaNacimiento in date,
	sp_email in varchar2,
	sp_fechaIngreso in date,
	sp_telefono in varchar2,
	
	sp_convenio in varchar2
);
END "PKG_CLIENTE";